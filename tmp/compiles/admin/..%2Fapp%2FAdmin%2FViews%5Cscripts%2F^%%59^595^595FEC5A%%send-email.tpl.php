<?php /* Smarty version 2.6.19, created on 2014-12-22 16:56:27
         compiled from index/send-email.tpl */ ?>
<form id="myform" name="myform" action="<?php echo $this -> callViewHelper('url', array(array('action'=>"send-email",)));?>"  method="post"  onsubmit="return checkinput()" target="ifrmSubmit">
<table width="100%" height="143" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="25%" height="35">　　邮件地址：</td>
    <td width="75%">
      <label>
        <input name="email"  id="email" type="text" size="20" maxlength="35" />
        </label>
      </td>
  </tr>
  <tr>
