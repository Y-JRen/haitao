<?php /* Smarty version 2.6.19, created on 2014-12-31 10:24:04
         compiled from product/assemble-apply.tpl */ ?>
...
{
    if (value == '1') {
        openDiv('<?php echo $this -> callViewHelper('url', array(array('controller'=>'product','action'=>'sel','type'=>'sel_status','logic_area'=>1,)));?>','ajax','查询商品',750,400);
    } else if (value == '2') {
        openDiv('<?php echo $this -> callViewHelper('url', array(array('controller'=>'product','action'=>'sel','type'=>'sel','logic_area'=>1,)));?>','ajax','查询商品',750,400);
    }
    bill_type = value;
}
