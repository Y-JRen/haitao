<?php /* Smarty version 2.6.19, created on 2015-01-05 16:50:29
         compiled from product/assemble-list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'product/assemble-list.tpl', 6, false),)), $this); ?>
...
<select name="status">
  ...
  <?php $_from = $this->_tpl_vars['search_option']['assemble_status']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['status']):
?>
  <option value="<?php echo $this->_tpl_vars['key']; ?>
" <?php if ($this->_tpl_vars['params']['status'] != '' && $this->_tpl_vars['params']['status'] == $this->_tpl_vars['key']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['status']; ?>
</option>
...
">
            <td>
                <input type="button" onclick="openDiv('<?php echo $this -> callViewHelper('url', array(array('action'=>"assemble-check",'assemble_id'=>$this->_tpl_vars['info']['assemble_id'],'query_type'=>'assemble_list',)));?>','ajax','查看单据',750,400)" value="查看">
            </td>
