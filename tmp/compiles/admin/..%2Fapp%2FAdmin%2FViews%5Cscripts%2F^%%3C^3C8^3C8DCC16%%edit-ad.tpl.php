<?php /* Smarty version 2.6.19, created on 2014-08-04 11:10:09
         compiled from ad/edit-ad.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'ad/edit-ad.tpl', 62, false),array('modifier', 'date_format', 'ad/edit-ad.tpl', 115, false),)), $this); ?>
<script src="/scripts/my97/WdatePicker.js" type="text/javascript" language="javascript"></script>
<script src="/haitaoadmin/scripts/fileuploader.js"></script>
<style>
.btn_submit:hover {
...
<form  name="myForm" id="myForm"  action="/admin/ad/edit-ad" method="post" onsubmit="return check_post()">
<div class="content">
<table width="100%" cellspacing="1" cellpadding="2" class="table_form">
<tbody>
<tr>
     <th width="80">广告名称 :</th>
     <td><input type="text" size="40" value="<?php echo $this->_tpl_vars['adInfo']['name']; ?>
" class="input-text" id="name" name="name"><div id="nameTip" class="onShow">请填写广告名称</div></td>
</tr>

    <tr>
    <th>广告链接 :</th>
     <td><input type="text" size="40" class="input-text"  value="<?php echo $this->_tpl_vars['adInfo']['url']; ?>
" name="url"></td>
   </tr>
    
    <tr><th>广告位 :</th><td><select id="board_id" name="board_id">
    <?php $_from = $this->_tpl_vars['adBoard']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?>
    <option  <?php if ($this->_tpl_vars['adInfo']['board_id'] == $this->_tpl_vars['item']['id']): ?>selected<?php endif; ?>  tpl="<?php echo $this->_tpl_vars['item']['tpl']; ?>
"   allowtype="<?php echo $this->_tpl_vars['adtpl'][$this->_tpl_vars['item']['tpl']]['allow_type']; ?>
" value="<?php echo $this->_tpl_vars['item']['id']; ?>
"><?php echo $this->_tpl_vars['item']['name']; ?>
（<?php echo $this->_tpl_vars['item']['width']; ?>
*<?php echo $this->_tpl_vars['item']['height']; ?>
）</option>
   ...
   <select id="type" name="type">
    <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['adType'],'selected' => $this->_tpl_vars['adInfo']['type']), $this);?>
  ...
  <th>广告图片 :</th>
  <td><input type="text" size="30" class="input-text fl mr10 tips" id="J_img" value="<?php echo $this->_tpl_vars['adInfo']['content']; ?>
"  name="image">
  ...
  <th>广告代码 :</th><td><textarea id="code" name="code" cols="50" rows="3"><?php echo $this->_tpl_vars['adInfo']['content']; ?>
</textarea></td></tr>
  <tr style="display:none;" class="bill_media" id="ad_flash">
  <th>广告动画 :</th>
  <td><input type="text" size="30" class="input-text fl mr10" id="J_flash"  value="<?php echo $this->_tpl_vars['adInfo']['content']; ?>
" name="flash">
  ...
  <th>文字内容 :</th><td><textarea id="text" name="text" cols="50" rows="3"><?php echo $this->_tpl_vars['adInfo']['content']; ?>
</textarea></td></tr>
  ...
  <tr class="bill_media" id="moreimg" style="display:none;">
    ...
    <p>
    <div><span class="fl">1. 链接：</span> <input type="text" size="30" class="input-text fl mr10" value="<?php echo $this->_tpl_vars['config'][0]['link']; ?>
" name="extConfig[0][link]"></div>
    <div><span class="fl"> 图片：</span><input type="text" size="30" class="input-text fl mr10 tips" id="J_more_1"  value="<?php echo $this->_tpl_vars['config'][0]['pic']; ?>
"  name="extConfig[0][pic]"></div> 
   ...
   <input type="file" name="file" style=" font-family: Arial; font-size: 118px; margin: 0px; padding: 0px; cursor: pointer; opacity: 0;"></div>
    ...
    <div><span class="fl">2. 链接：</span> <input type="text" size="30" class="input-text fl mr10" value="<?php echo $this->_tpl_vars['config'][1]['link']; ?>
"   name="extConfig[1][link]"></div>
    <div><span class="fl"> 图片：</span><input type="text" size="30" class="input-text fl mr10 tips" id="J_more_2"  value="<?php echo $this->_tpl_vars['config'][1]['pic']; ?>
"  name="extConfig[1][pic]"></div> 
   <div class="upload_btn" id="J_upload_more_2" style="position: relative; overflow: hidden; direction: ltr;"><span>上传</span>
   <input type="file" name="file" style=" font-family: Arial; font-size: 118px; margin: 0px; padding: 0px; cursor: pointer; opacity: 0;"></div>
   </p>
      
    <p style="clear:both;padding-top:10px;">
    <div><span class="fl">3. 链接：</span> <input type="text" size="30" class="input-text fl mr10" value="<?php echo $this->_tpl_vars['config'][2]['link']; ?>
"   name="extConfig[2][link]"></div>
    <div><span class="fl"> 图片：</span><input type="text" size="30" class="input-text fl mr10 tips" id="J_more_3" value="<?php echo $this->_tpl_vars['config'][2]['pic']; ?>
"  name="extConfig[2][pic]"></div> 
  ...
  <tr><th>扩展图片 :</th><td><input type="text" size="30" class="input-text fl mr10 tips" id="J_extimg" name="extimg" value="<?php echo $this->_tpl_vars['adInfo']['extimg']; ?>
">
  <div class="upload_btn" id="J_upload_extimg" style="position: relative; overflow: hidden; direction: ltr;"><span>上传</span>
  <input type="file" name="file" style="font-family: Arial; font-size: 118px; margin: 0px; padding: 0px; cursor: pointer; opacity: 0;"></div></td></tr>
  <tr><th>扩展字段值 :</th><td><input type="text" class="input-text fl mr10" name="extval" value="<?php echo $this->_tpl_vars['adInfo']['extval']; ?>
"></td></tr>
  <tr><th>广告描述 :</th><td><input type="text" size="30" class="input-text fl mr10" name="desc" value="<?php echo $this->_tpl_vars['adInfo']['desc']; ?>
"></td></tr>
  <tr><th>广告时间 :</th><td><input type="text" size="20" class="Wdate"  value="<?php echo ((is_array($_tmp=$this->_tpl_vars['adInfo']['start_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
 "  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  id="start_time" name="start_time"> - 
  <input type="text" size="20" class="Wdate"   onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['adInfo']['end_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
" id="end_time" name="end_time"></td></tr>
  <tr>
  
  <th>是否启用 :</th>
   <td><label><input type="radio" <?php if ($this->_tpl_vars['adInfo']['status'] == 1): ?>checked=""<?php endif; ?> value="1" name="status">是</label>&nbsp;&nbsp;
<label><input type="radio" <?php if ($this->_tpl_vars['adInfo']['status'] == 0): ?>checked=""<?php endif; ?>  value="0" name="status">否</label></td></tr>
   </tbody>
 </table>
</div>

<div class="submit">
<input type="hidden" value="<?php echo $this->_tpl_vars['adInfo']['id']; ?>
" name="id" />
<input type="hidden" value="<?php echo $this->_tpl_vars['back_url']; ?>
" name="back_url" />
