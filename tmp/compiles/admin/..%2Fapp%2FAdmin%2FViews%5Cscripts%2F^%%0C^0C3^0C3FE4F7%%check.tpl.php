<?php /* Smarty version 2.6.19, created on 2014-12-31 10:22:32
         compiled from cost/check.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'cost/check.tpl', 60, false),)), $this); ?>
...
"/></td>
        <td>
			<input type="button" onclick="openDiv('<?php echo $this -> callViewHelper('url', array(array('action'=>'checkdetail','id'=>$this->_tpl_vars['data']['bill_id'],'flag'=>2,)));?>','ajax','查看单据',750,400)" value="查看">
        </td>
