<?php /* Smarty version 2.6.19, created on 2014-12-19 16:49:04
         compiled from logic-area-out-stock/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'logic-area-out-stock/add.tpl', 114, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['item']; ?>
    ...
    <?php if ($this->_tpl_vars['logic_area'] <= 10): ?>
...
"><?php echo $this->_tpl_vars['s']['supplier_name']; ?>
</option>
      <?php endif; ?>
      <?php endforeach; endif; unset($_from); ?>
      </select>
    ...
    <tr>
      <td colspan="2">
      <input type="button" onclick="openDiv('<?php echo $this -> callViewHelper('url', array(array('controller'=>'product','action'=>'sel','type'=>'sel_stock','logic_area'=>$this->_tpl_vars['logic_area'],)));?>/sid/'+$('supplier_id').value,'ajax','查询商品',750,400);" value="查询添加商品">
      <?php if ($this->_tpl_vars['logic_area'] == '1' && $this->_tpl_vars['type'] == 2): ?><input type="button" onclick="openDiv('/admin/goods/sel/type/2/','ajax','查询组合商品',750,450,true,'sel');" value="查询添加组合商品"><?php endif; ?>
      </td>
    </tr>
</tbody>
</table>
	...
	for (i = 1; i < el.length; i++) {
		if (el[i].checked) {
		    if ($('pinfo' + el[i].value) != null) {
    			...
    			tr.cells[5].innerHTML = '<span id="show_number' + id + '">' + pinfo.able_number + '<input type="hidden" name="stock_number[]" value="' + pinfo.able_number + '"></span>';
    			...
    			tr.cells[7].innerHTML = '<input type="text" size="6" name="number[]" id="number' + batch_id + '" value="0" class="required" msg="不能为空" onblur="checkNum(this, ' + pinfo.able_number + ')" onchange="caluAmount()"/>';
    			obj.appendChild(tr);
		    }
