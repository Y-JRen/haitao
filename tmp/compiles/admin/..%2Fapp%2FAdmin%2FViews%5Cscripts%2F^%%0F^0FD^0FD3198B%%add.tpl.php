<?php /* Smarty version 2.6.19, created on 2014-12-22 17:27:16
         compiled from transport/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'transport/add.tpl', 17, false),)), $this); ?>
...
function getLogistic()
{
    ...
    new Request({
        url: '<?php echo $this -> callViewHelper('url', array(array('action'=>"get-logistic",)));?>/is_cod/' + is_cod,
        method: 'post',
