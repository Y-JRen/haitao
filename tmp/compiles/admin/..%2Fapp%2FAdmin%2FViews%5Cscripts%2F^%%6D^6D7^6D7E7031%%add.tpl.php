<?php /* Smarty version 2.6.19, created on 2015-06-24 11:10:45
         compiled from order/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'order/add.tpl', 17, false),)), $this); ?>
<script language="javascript" type="text/javascript" src="/scripts/my97/WdatePicker.js"></script>
<form id="myform1">
<input type="hidden" name="logic_area" id="logic_area" value="<?php echo $this->_tpl_vars['lid']; ?>
">
<input type="hidden" name="shop_id" id="shop_id" value="1">
 <div class="search" > 
     <div style="padding-left:10px;">
      ...
      <div style="padding-left:10px;">
      下单时间：<input type="text" name="add_time" id="add_time" size="22" value="<?php echo $this->_tpl_vars['add_time']; ?>
"  class="Wdate" onClick="WdatePicker()" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
      ...
      仓库：<select id="lid" name="lid" onchange="changetype($('type').value)">
              <?php if ($this->_tpl_vars['lid'] == 1): ?><option value="1">香港仓</option><?php endif; ?>
              <?php if ($this->_tpl_vars['lid'] == 2): ?><option value="2">日本仓</option><?php endif; ?>
            </select>  
        下单类型：  
...
?>
              <?php if ($this->_tpl_vars['shop']['shop_id'] != 1): ?>
