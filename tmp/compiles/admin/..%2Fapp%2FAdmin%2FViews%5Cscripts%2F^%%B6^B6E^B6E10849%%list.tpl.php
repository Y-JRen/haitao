<?php /* Smarty version 2.6.19, created on 2014-08-20 18:02:42
         compiled from logic-area-out-stock/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'logic-area-out-stock/list.tpl', 20, false),array('modifier', 'date_format', 'logic-area-out-stock/list.tpl', 96, false),)), $this); ?>
...
" class="Wdate" onClick="WdatePicker()"/>
出库开始日期：<input type="text" name="fromdate2" id="fromdate2" size="11" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['param']['fromdate2'])) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
" class="Wdate" onClick="WdatePicker()"/>
出库结束日期：<input type="text" name="todate2" id="todate2" size="11" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['param']['todate2'])) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
" class="Wdate" onClick="WdatePicker()"/>
</div>
<div class="line">
...
<option value="">选择单据类型</option>
  ...
  <?php $_from = $this->_tpl_vars['billType']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
  <?php if ($this->_tpl_vars['param']['bill_type'] != 18 || $this->_tpl_vars['key'] == 18): ?>
  <option value="<?php echo $this->_tpl_vars['key']; ?>
...
<div class="content">
    ...
    <b>总成本：<?php echo $this->_tpl_vars['sum']['cost']; ?>
&nbsp;&nbsp;&nbsp;总成本(未税)：<?php echo $this->_tpl_vars['sum']['no_tax_cost']; ?>
&nbsp;&nbsp;&nbsp;</b>
    </div>
    <?php endif; ?>
...
"/></td>
        <td>
			<input type="button" onclick="openDiv('<?php echo $this -> callViewHelper('url', array(array('action'=>$this->_tpl_vars['operates'][$this->_tpl_vars['action']],'id'=>$this->_tpl_vars['data']['outstock_id'],)));?>','ajax','查看单据',750,400)" value="查看">
        </td>
