...
class Admin_LogicAreaController extends Zend_Controller_Action 
{
	/**
     * api对象
     */
	...
	const ADD_SUCCESS = '添加仓库成功!';
	const EDIT_SUCCESS = '编辑仓库成功!';
	...
	{
		$this -> _api = new Admin_Models_API_LogicArea();
	}
