...
<tbody>
    ...
    <tr>
      ...
      <td><input type="text" name="market_price" size="8" value="{{$data.market_price|default:0.00}}" msg="请填写市场价" class="required" /></td>
    </tr>
    <tr> 
      <td width="10%"><strong>本店价</strong> * </td>
      <td><input type="text" name="shop_price" id="shop_price" size="8" onchange="calc()" value="{{$data.shop_price|default:0.00}}" msg="请填写本店价" class="required" /></td>
    </tr>
    <tr> 
      <td width="10%"><strong>完税价</strong> * </td>
      <td><input type="text" name="org_tax_price" id="org_tax_price" size="8" onchange="calc()" value="{{$data.org_tax_price|default:0.00}}" msg="请填写完税价" class="required" /></td>
    </tr>
    <tr> 
      <td width="10%"><strong>计量单位</strong> * </td>
      <td><input type="text" name="measurement_unit" id="measurement_unit" size="8" onchange="calc()" value="{{$data.measurement_unit|default:0}}" msg="请填写计量单位" class="required" /></td>
    </tr>
     <tr> 
      <td width="10%"><strong>税率</strong> * </td>
      <td><input type="text" name="tax_rate" id="tax_rate" size="8" onchange="calc()" value="{{$data.tax_rate|default:0}}" msg="请填写税率" class="required" /></td>
    </tr>
    <tr> 
      <td width="10%"><strong>行邮税</strong> * </td>
      <td><input type="text" name="tax" id="tax" size="8" value="{{$data.tax|default:0.00}}" onchange="javascript:alert('aaa');" msg="请填写行邮税" class="required" readonly="readonly"/></td>
    </tr>
   <!--  <tr> 
      <td width="10%"><strong>运费</strong> * </td>
      <td><input type="text" name="fare" id="fare" size="8" onchange="calc()" value="{{$data.fare|default:0.00}}" msg="请填写本店价" class="required" /></td>
    </tr> -->
    <tr> 
      <td width="10%"><strong>商品总价</strong> * </td>
      <td><input type="text" name="price" id="price" size="8" readonly="readonly" value="{{$data.price|default:0.00}}" msg="请填写本店价" class="required" /></td>
    </tr>
    <tr>
