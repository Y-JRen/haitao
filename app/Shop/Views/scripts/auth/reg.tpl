		...
		<ul class="register_infor">
			...
			<li>
				...
				<div class="register_code">
					...
					<div class="code_img"><img src="/auth/auth-image/space/shopRegister/code/{{$smarty.now}}" onclick="change_verify('verify_img','shopRegister');" id="verify_img"   width="64" height="36" align="absmiddle" style="margin-top:3px;margin-left:5px; "/></div>
