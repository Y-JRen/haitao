...
class Custom_Model_Upload
{
	...
	public $uploads = 0;
	public $uploadeds = 0;
	public $imageexts = array('gif', 'jpg', 'jpeg', 'png', 'bmp','swf', 'apk', 'ipa', 'xls');
	public $uploadedfiles = array();
	public $error;

	function __construct($inputname, $savepath = '', $savename = '', $alowexts = 'jpg|jpeg|gif|bmp|png|swf|apk|ipa|xls', $maxsize = 2048000, $overwrite = 0)
	{
