...
class Custom_Model_String
{
     ...
     * @param    string    $ext       追加字符串
     *
     * @return  string
     */
    public static function subString($string, $start = 0, $length, $ext = "...")
    {
	    $subLength = $start + $length;
        if (self::strLeng($string) <= $subLength) {
    	    return $string;
        }
     ...
     * @return   int
     */
    public static function strLeng($string)
    {
